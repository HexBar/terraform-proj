...
sudo chmod +x /var/lib/waagent/custom-script/download/0/terraform/terraform-infrastructure/flaskApp/flaskApp.py

sudo python3 /var/lib/waagent/custom-script/download/0/terraform/terraform-infrastructure/flaskApp/flaskApp.py > output.log 2>&1 &

echo "python is running successfully"

APP_PATH="/var/lib/waagent/custom-script/download/0/terraform/terraform-infrastructure/flaskApp"
